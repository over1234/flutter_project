...
import 'package:wisehealthylife/screen/game_sub_screen.dart';
...
class TermPage extends StatefulWidget {
  final String roomID;
  const TermPage({Key? key, required this.roomID}) : super(key: key);

  @override
  _TermPageState createState() => _TermPageState(roomID: this.roomID);
}

class _TermPageState extends State<TermPage> {
  final String roomID;
  _TermPageState({required this.roomID});
...
//1111111111111111111111111111111111111111111111111111111111111111111111111111111
  ...
  Future<void> UpdateTime() async {
    ...
    FirebaseFirestore.instance.collection("PrivateRoom").doc(roomID).update({"Time":"${time[index]}"});
  }
}