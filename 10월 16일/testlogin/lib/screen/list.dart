              ...
              return Container(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    FirebaseFirestore.instance.collection("Users").doc(user?.uid).get().then((DocumentSnapshot ds){
                      String username = ds['username'];
                      FirebaseFirestore.instance.collection("PrivateRoom").doc(document.id).update({"Users" : FieldValue.arrayUnion([username])});
                    });
