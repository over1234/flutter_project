...
import 'package:testlogin/provider/Thankyou.dart';
import 'package:testlogin/provider/Timer.dart';
import 'package:testlogin/provider/pedometer.dart';
import 'package:testlogin/provider/speedmitor.dart';
                ...
                Container(
                  child: Row(
                    ...
                    children: [
                      ...
                      Text("인터벌", style: TextStyle(color: Colors.black, fontSize: 15, fontWeight: FontWeight.bold, fontFamily: 'Jua',),),
                      Container(
                ...
                Container(
                  child: Row(
                    ...
                    children: [
                      ...
                      Text("걷기", style: TextStyle(color: Colors.black, fontSize: 15, fontWeight: FontWeight.bold, fontFamily: 'Jua',),),
                      Container(
                        padding: EdgeInsets.only(right: 145.0),
                      ),
                      Text("밝기", style: TextStyle(color: Colors.black, fontSize: 15, fontWeight: FontWeight.bold, fontFamily: 'Jua',),),
                    ],
                  ),
                ),
                Container(
                ...
                Container(
                  child: Row(
                    ...
                    children: [
                      ...
                      Text("고운말", style: TextStyle(color: Colors.black, fontSize: 15, fontWeight: FontWeight.bold, fontFamily: 'Jua',),),
                    ],
                  ),
                ),
              ],
