...
import 'package:wisehealthylife/provider/light.dart';
  ...
  callPermission_1() async {
    ...
    if (status.isGranted) {
      Navigator.push(
        context,
        Transition(
            child: Walk(), transitionEffect: TransitionEffect.LEFT_TO_RIGHT),
      );
    }
